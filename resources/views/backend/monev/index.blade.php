            ...
            <div class="col-12">
                ...
                <div class="card card-table-border-none recent-orders" id="recent-orders">
                    <div class="card-header justify-content-between">
                        <a href="{{ route('backend.monev.add', $type) }}" class="btn btn-primary btn-default">TAMBAH +</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $key => $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('backend.monev.edit', [$type, $row->id]) }}"
                                                class="btn btn-info btn-sm">EDIT</a>
                                            <a href="{{ route('backend.monev.delete', [$type, $row->id]) }}"
